...
class ApplicationGUI(tk.Tk):
    def __init__(self):
        super().__init__()
        self.title("LogSentinel Studio — Visual Production Log Analyzer GUI")
        ...
        title_label = ttk.Label(header_frame, text="⚡ LogSentinel Studio — Visual Production Log Analyzer GUI", style="Header.TLabel")
        title_label.pack(anchor="w")
        
        sub_label = ttk.Label(header_frame, text="Graphical desktop log parser visualizing log error rates, anomaly spikes, and real-time log tailing.", foreground="#94A3B8")
